...
<div class="wrapper">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="/viewallposts" class="nav-link active">
  ...
  <div class="content-wrapper">
    <h2 class="ml-2">View All Posts</h2>
    <hr>
    <div class="col-12">
      <table class="table">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <a href="editpost/{{$post->id}}" target="popup" onclick="window.open('editpost/{{$post->id}}','popup','width=800,height=800')" class="btn btn-primary btn-sm" >
                edit post
              </a>
              <a  href="deletepost/{{$post->id}}" class="btn btn-danger btn-sm">Delete Post</a>
            </td>
          </tr>
          @endforeach
