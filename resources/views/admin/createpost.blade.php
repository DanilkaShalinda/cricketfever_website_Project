...
<div class="wrapper">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="/createpost" class="nav-link active">
  ...
  <div class="content-wrapper">
    ...
    <div class="col-8">
      ...
      @endif
      <form action="/postcreated" method="POST" enctype="multipart/form-data">
        {{ csrf_field() }}
        ...
        <div class="form-group">
          <label for="postdescription">Attach Cover Image</label>
          <div class="form-group">

          <input type="file" name="cover_image" class="form-control" id="exampleFormControlInput1" placeholder="cover image">
