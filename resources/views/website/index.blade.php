...
<head>
    ...
    <link href="website/css/media_query.css" rel="stylesheet" type="text/css"/>
    ...
    <link href="website/css/owl.theme.default.css" rel="stylesheet" type="text/css"/>
    <!-- Bootstrap CSS -->
    <link href="website/css/style_1.css" rel="stylesheet" type="text/css"/>
    <!-- Modernizr JS -->
    <script src="website/js/modernizr-3.5.0.min.js"></script>
    ...
    <div class="container">
        <div class="row">
            <div class="col-12 col-md-3 fh5co_padding_menu">
                <img src="website/images/logo.png" alt="img" class="fh5co_logo_width"/>
            </div>
...
<div class="container-fluid bg-faded fh5co_padd_mediya padding_786">
    <div class="container padding_786">
        <nav class="navbar navbar-toggleable-md navbar-light ">
            ...
            <a class="navbar-brand" href="#"><img src="website/images/logo.png" alt="img" class="mobile_logo_width"/></a>
                ...
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="dropdownMenuButton3" data-toggle="dropdown"
                           aria-haspopup="true" aria-expanded="false">Series<span class="sr-only">(current)</span></a>
...
<div class="container-fluid paddding mb-5">
    <div class="row mx-0">
        <div class="col-md-6 col-12 paddding animate-box" data-animate-effect="fadeIn">
            <div class="fh5co_suceefh5co_height"><img src="website/images/nick-karvounis-78711.jpg" alt="img"/>
        ...
        <div class="col-md-6">
            <div class="row">
                ...
                <div class="col-md-6 col-6 paddding animate-box" data-animate-effect="fadeIn">
                    <div class="fh5co_suceefh5co_height_2"><img src="website/images/joe-gardner-75333.jpg" alt="img"/>
                        <div class="fh5co_suceefh5co_height_position_absolute"></div>
                        <div class="fh5co_suceefh5co_height_position_absolute_font_2">
                ...
                <div class="col-md-6 col-6 paddding animate-box" data-animate-effect="fadeIn">
                    <div class="fh5co_suceefh5co_height_2"><img src="website/images/ryan-moreno-98837.jpg" alt="img"/>
                        <div class="fh5co_suceefh5co_height_position_absolute"></div>
                        <div class="fh5co_suceefh5co_height_position_absolute_font_2">
                            <div class=""><a href="#" class="color_fff"> <i class="fa fa-clock-o"></i>&nbsp;&nbsp;Oct
                                28,2017 </a></div>
                ...
                <div class="col-md-6 col-6 paddding animate-box" data-animate-effect="fadeIn">
                    <div class="fh5co_suceefh5co_height_2"><img src="website/images/10-1-1-875x500.jpg" alt="img"/>
                        <div class="fh5co_suceefh5co_height_position_absolute"></div>
                        <div class="fh5co_suceefh5co_height_position_absolute_font_2">
                            <div class=""><a href="#" class="color_fff"> <i class="fa fa-clock-o"></i>&nbsp;&nbsp;Oct
                                28,2017 </a></div>
        ...
        @foreach ($posts as $post )
            <div class="item px-2">
                <div class="fh5co_hover_news_img">
                    <div class="fh5co_news_img"><img src="{{asset('storage/' .$post->cover_image )}}" alt=""/></div>
                    <div>
                        <a href="single.html" class="d-block fh5co_small_post_heading"><span class="">{{$post ['title']}}</span></a>
                        <div class="c_g"><i class="fa fa-clock-o"></i> {{$post ['updated_at']}}</div>
                    </div>
                </div>
            </div>
        @endforeach
...
<div class="container-fluid fh5co_video_news_bg pb-4">
    <div class="container animate-box" data-animate-effect="fadeIn">
        <div>
            <div class="fh5co_heading fh5co_heading_border_bottom pt-5 pb-2 mb-4  text-black">Video News</div>
        </div>
        <div>
                    ...
                    <div class="fh5co_hover_news_img">
                        <div class="fh5co_hover_news_img_video_tag_position_relative">
                            ...
                            <div class="fh5co_hover_news_img_video_tag_position_absolute fh5co_hide">
                                <img src="website/images/ariel-lustre-208615.jpg" alt=""/>
                            </div>
                    ...
                    <div class="fh5co_hover_news_img">
                        <div class="fh5co_hover_news_img_video_tag_position_relative">
                            ...
                            <div class="fh5co_hover_news_img_video_tag_position_absolute fh5co_hide_2">
                                <img src="website/images/39-324x235.jpg" alt=""/></div>
                    ...
                    <div class="fh5co_hover_news_img">
                        <div class="fh5co_hover_news_img_video_tag_position_relative">
                            ...
                            <div class="fh5co_hover_news_img_video_tag_position_absolute fh5co_hide_3">
                                <img src="website/images/joe-gardner-75333.jpg" alt=""/></div>
                    ...
                    <div class="fh5co_hover_news_img">
                        <div class="fh5co_hover_news_img_video_tag_position_relative">
                            ...
                            <div class="fh5co_hover_news_img_video_tag_position_absolute fh5co_hide_4">
                                <img src="website/images/vil-son-35490.jpg" alt=""/>
                            </div>
                ...
                <div class="row pb-4">
                    <div class="col-md-5">
                        <div class="fh5co_hover_news_img">
                            ...
                            <div class="fh5co_news_img"><img src="{{asset('storage/' .$post->cover_image )}}" /></div>
                        </div>
                    </div>
                    <div class="col-md-7 animate-box">
                        <a href="single.html" class="fh5co_magna py-2"> {{$post ['title']}}</a> <a href="single.html" class="fh5co_mini_time py-3"> {{$post ['updated_at']}}</a>
                        <div class="fh5co_consectetur"> {{$post ['description']}}
                        </div>
                    </div> <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/5.0.0-alpha1/css/bootstrap.min.css" integrity="sha384-r4NyP46KrjDleawBgD5tp8Y7UzmLA05oM1iAEQ17CSuDqnUK2+k9luXQOfXJCJ4I" crossorigin="anonymous">
...
<div class="container-fluid fh5co_footer_bg pb-3">
    <div class="container animate-box">
        <div class="row">
            <div class="col-12 spdp_right py-5"><img src="website/images/white_logo.png" alt="img" class="footer_logo"/></div>
            <div class="clearfix"></div>
            ...
            <div class="col-12 col-md-6 col-lg-6 ">
                ...
                @foreach ($posts as $post)
                <a href="#" class="footer_img_post_6"><img src="{{asset('storage/' .$post->cover_image )}}" alt="img"/></a>
                @endforeach
            </div>
        </div>
