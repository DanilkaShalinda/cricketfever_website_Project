            ...
            <div class="col-12 col-md-6">
                ...
                <form action="/sendmessage" method="POST" class="row" >
                    ...
                    <div class="col-12 py-3">
                        <input name="name" type="text" class="form-control fh5co_contact_text_box" placeholder="Enter Your Name" />
                    </div>
                    <div class="col-6 py-3">
                        <input name="email" type="text" class="form-control fh5co_contact_text_box" placeholder="E-mail" />
                    </div>
                    <div class="col-6 py-3">
                        <input name="subject" type="text" class="form-control fh5co_contact_text_box" placeholder="Subject" />
                    </div>
                    <div class="col-12 py-3">
